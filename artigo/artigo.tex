...
Diante disso, a equipe HP Laboratories modelou matematicamente um \emph{memristor}, essencialmente, a partir de duas equações (Equações (\ref{eq01}) e (\ref{eq02})), sendo que a Equação (\ref{eq02}) considera a interação física intrínseca do componente por meio da variável de estado $w$.
