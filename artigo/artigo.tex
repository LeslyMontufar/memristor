...
\caption{(a) Curva $\varphi$-$q$ de um memristor. (b) Relação entre a tensão de entrada $v(t)$ e a variável de estado $x(t)$. (c) Curva $v$-$i$ de um memristor, chamado de \emph{pinched hysteresis loop} por Chua.}\label{simulacao}
\end{figure*}
%% Lisajous Figures
