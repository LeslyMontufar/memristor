...
\section{CONCLUSÕES}
O \emph{}
%% Enaltecer o memristor como em: mas não copiar
...
%% Próximos trabalhos: futuros e recentes estudos
promissor no campo da nanotecnologia, microeletrônica, computação e aplicações em redes neurais.
\end{comment}

\section{CONCLUSÕES}
%O \emph{memristor}
%% Enaltecer o memristor como em: mas não copiar
O memristor, portanto, é o mais novo elemento fundamental de circuitos, sendo considerado o quarto elemento, ao lado do resistor, capacitor e indutor. O novo elemento contempla a seguinte relação matemática:

\begin{equation*}
M(q) =\dfrac{df(q)}{dq}
\end{equation*}

onde M(q) representa a Memristência, ou seja, resistência do memristor. 

A nova descoberta possui diversas aplicabilidades, sendo muito importante para o desenvolvimento atual das áreas de conhecimento da nanotecnologia, microeletrônica, computação e até mesmo inteligência artificial. Embora bem pouco conhecido, o memristor já propõe diferenciais nos sistemas nos quais é utilizado, como memórias Reram, tornando-as muito mais eficientes, por armazenar dados como resistência, e nos circuitos híbridos, aprimorando a comunicação entre pequenas células de circuitos neuromórfico. Assim, o novo dispositivo chamado  Memristor merece ser matéria de novos estudos e pesquisas.
...
\bibitem{you} % indescritivel
    ...
    Disponível em: \url{https://www.youtube.com/watch?v=QFdDPzcZwbs}. Acesso em ago. 2019.
