...
%pela relação $d\varphi=M dq$, da qual equivalentemente tem-se $v=M(q)i$.
%, na qual tem-se que a \emph{memristência} $M$ é mensurada na mesma unidade que a resistência. 
